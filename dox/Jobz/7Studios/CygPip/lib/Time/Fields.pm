# 382C8tQ - Time::Fields.pm created by Pip@CPAN.Org as an abstract base class for more specialized Time objects (Time::Frame && Time::PT).
package Time::Fields;
use strict;
use warnings;
...
Time::Fields, which was released on ptptIME.
