# 37VG26k - Time::Frame.pm created by Pip@CPAN.Org to make simple objects for frames of time.
package Time::Frame;
use strict;
use warnings;
require      Time::Fields;
...
sub new {
  ...
  for my $attr ( @attz ) { #$self->_attribute_names() ) {
...
Time::Frame, which was released on ptptIME.
