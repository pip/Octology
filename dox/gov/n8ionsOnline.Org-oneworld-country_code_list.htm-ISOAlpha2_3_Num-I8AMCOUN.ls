# I8AMCOUN:~/dox/gov/n8ionsOnline.Org-oneworld-country_code_list.htm-ISOAlpha2_3_Num-I8AMCOUN.ls copy/pasted by PipStuart <Pip@CPAN.Org> for local loc8 code;
# 2du:stor && cnfirm Airport && Country Dialing Codes similarly,mAB replace Name spaces with underscores or strip && add CamelCase,add2 .Hrc or lib/a8 4 l8r;
  CountryOrAreaName                                                                                                               ISOCodes:  Alpha2  Al3  Num
