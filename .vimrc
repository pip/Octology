...
let  g:VERSION='0.0'
let     g:d8VS='KCJL7new'     " d8VersionString - l8st significant upd8 to whole file was then
...
" hi      User1                  cterm=NONE ctermbg=DarkBlue ctermfg=Yellow      " this block was trying to simUl8 the tmp YGTBUDSN d8bo B4 switching back2Dflt
...
" hi      User9                  cterm=NONE ctermbg=DarkBlue ctermfg=DarkMagenta
